    ...
    return (
        <header className="h-[68px] bg-white/80 backdrop-blur-2xl sticky top-0 z-10 flex items-center justify-between px-8 border-b border-slate-200/50 shadow-sm transition-all duration-300">
            ...
            <div className="flex items-center gap-3 md:gap-5">
                ...
                {/* Notifications */}
                <button className="relative p-2 text-slate-400 hover:text-teal-600 transition-all duration-300 rounded-full hover:bg-teal-50 flex items-center justify-center cursor-pointer">
